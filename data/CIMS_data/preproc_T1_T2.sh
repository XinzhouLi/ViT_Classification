...
antsBrainExtraction.sh -d 3 -a T1_restore.nii.gz -e $FSLDIR/data/standard/MNI152_T1_1mm.nii.gz -m T1_MNI_mask.nii.gz -o T1 -c 4x1x2x3
mv T1BrainExtractionBrain.nii.gz T1_brain.nii.gz
antsBrainExtraction.sh -d 3 -a T2_restore.nii.gz -e $FSLDIR/data/standard/MNI152_T1_1mm.nii.gz -m T1_MNI_mask.nii.gz -o T2 -c 4x3x2x1
#$FSLDIR/data/atlases/JHU/JHU-ICBM-T2-1mm.nii.gz
mv T2BrainExtractionBrain.nii.gz T2_brain.nii.gz


fslcpgeom T1 T1_brain
fslcpgeom T2 T2_brain
